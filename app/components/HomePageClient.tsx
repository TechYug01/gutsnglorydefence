  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] max-w-[900px] mx-auto px-6 pt-32 pb-24 text-center">
        ...
        <h1 className="animate-fade-in-up text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tighter text-white leading-[1.1] mb-6">
          Forge Your Path{" "}
          <span
            style={{
        ...
        <p className="animate-fade-in-up stagger-2 opacity-0 text-white/80 text-lg md:text-xl font-serif italic leading-relaxed mb-8 max-w-3xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-[repeat(auto-fit,minmax(180px,1fr))] gap-8 text-center">
        {stats.map((stat) => (
          ...
          >
            ...
            >
              {stat.value === "2000+" ? <><Counter to={2000} />+</> :
               stat.value === "15+" ? <><Counter to={15} />+</> :
               stat.value === "87%" ? <><Counter to={87} />%</> :
               stat.value === "100%" ? <><Counter to={100} />%</> : stat.value}
            </span>
...
function FeaturesSection() {
  ...
  return (
    <section id="features" className="py-12 md:py-24 px-6 bg-background">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          <span className="inline-block text-xs font-bold text-gold tracking-[2.5px] uppercase mb-3">
            Why Choose Guts N Glory
          </span>
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-black uppercase tracking-tighter text-foreground mb-6">
            What Makes <span >Guts N Glory</span> Different
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-7xl mx-auto">
          {features.map((f, idx) => (
            <motion.div
              ...
              className="group bg-card border border-gold/20 rounded-3xl p-5 md:p-8 hover:border-yellow-500/50 transition-colors shadow-sm"
            >
              <div className="w-12 h-12 rounded-xl bg-surface flex items-center justify-center text-gold mb-6 group-hover:scale-110 group-hover:bg-yellow-500 group-hover:text-black transition-all duration-300">
                {f.icon}
              </div>
              <h3 className="text-lg md:text-xl font-black uppercase tracking-tight text-foreground mb-3">
                {f.title}
              </h3>
        ...
        >
          <p className="text-base md:text-lg font-black text-gold uppercase tracking-widest mb-2">
            OUR MISSION IS SIMPLE - TO TURN ASPIRANTS INTO OFFICERS.
          </p>
          <p className="text-sm md:text-md font-medium text-muted uppercase tracking-wider flex items-center justify-center gap-3">
...
function CoursesSection({ courses }: { courses: Course[] }) {
  return (
    <section id="courses" className="py-12 md:py-24 px-6 bg-surface">
      <div className="max-w-7xl mx-auto">
  ...
  return (
    ...
    >
      <div className="relative z-[1] max-w-[700px] mx-auto text-center">
        ...
        <p className="text-[1.1rem] leading-relaxed text-white/80 max-w-[520px] mx-auto mb-10">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          >
            ...
            <div className="leading-tight text-left">
              <span className="text-[0.6rem] text-white/60 block">
                GET IT ON
              </span>
